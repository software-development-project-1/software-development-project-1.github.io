...
For example let's consider these three user stories from the first Sprint:
...
As mentioned, the reference user story is the first user story of the first Sprint:
...
> 2. Organize a planning poker event in which you estimate the user stories of the Sprint
> 3. Based on the user story estimation, add the story point labels for the user story related issues
