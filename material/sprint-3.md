...
> Exercise 6
>
> Implement _at least two_ user stories in separate feature branches. Once the implementation is ready, open a pull request. At least one other team member should conduct a code review for the pull request and either approve or request changes. Once the pull request has been approved, merge it to the main branch.
