...
> Exercise 12
>
> During the course, each team will develop a project described by the Product Owner in the [project description](/project-description). Come up with seven user stories based on the project description. Use the "As [a user persona], I want [to perform this action] so that [I can accomplish this goal]" format for the user stories. Keep in mind the INVEST criteria and general guideliness of a good user story.
>
