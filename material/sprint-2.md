...
3. Together, pick at least two success area during the Sprint from the _glad_ category and two most urgent issue from the _mad_ and _sad_ categories. Come up with at least two _concrete_ actions to solve the issues during the upcoming Sprint. For example a concrete action for the issues "I always have conflicts when I try to pull code from the GitHub" could be "Pull code from GitHub more often" and "Create smaller commits and push code to GitHub more often"
