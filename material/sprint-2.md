...
>
> 1. The project's architecture consists of three components: the database, the backend and the frontend. Mention these components and explain the purpose of each component. If you want, you can visualize how the components communicate with each other using a [Mermaid flow diagram](https://mermaid.js.org/syntax/flowchart.html)
