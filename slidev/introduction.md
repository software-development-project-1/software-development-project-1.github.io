...
- The learning objectives for this week are:
  ...
  - Knowing how software development is carried out in practice and what kind of common problem areas it has
  - Knowing what is agile software development
  - Knowing what is the software development lifecycle and how it fits the agile software development
  - Knowing what is Scrum and how it is related to the agile software development
  - Knowing how stakeholders' requirements are managed in agile software development

---

## About the course

- So far during the studies we have mostly worked on fairly small applications by ourselves
- Different kinds of problems arise while we work on more complicated applications in a software development team
...
- Each team will be developing a quiz management application described in more detail on the course page
- The final application will be a full stack web application in which a frontend communicates with a backend
...
- Based on these assessment criteria, the team receives a **project grade** (0-5)
...
- Each team member receives a **personal grade** (0-5) based on their personal efforts towards the project and individual exercises
...
- The following are necessary to pass the course:
  - At least 60% of first and second week's exercises must be completed
...
- In the real world software is developed in **software development projects** by a diverse group of people referred to as the **software development team**
- Depending on the budget and scope of the project, the timespan of a software development can be anything from a few months to many years
...
- The people or groups of people affected by a software development project are referred to as the software development project's **stakeholders**
- On top of technical skills, the future of software developer's work will most likely consist more and more of understanding the needs of the stakeholders and applying technical solutions to meet those needs
...
- The team can consist for example of a representative of the end users (commonly referred to as a product owner), user-experience (UI) and user-interface (UX) designers and software developers
- The size of the team varies, but they commonly consist of fewer than 10 people
- So that a software development team can work together efficiently they need to follow a **common process** in their day-to-day work
- This process is referred to as a **software development process**

---

## Problems with software development projects

- Developing software based on the stakeholders' needs in a software development team isn't simple and many things can (and often do) go wrong
...
- Based on a [study conducted in 2022](https://idego-group.com/blog/2022/02/17/problems-in-software-development-developers-survey-results-blog/), **70% of software development problems are non-technical**. The three most common problems raised were:
  - **Management issues**: excessive product owners, unclear task descriptions, unrealistic schedules, and constantly changing requirements
  - **Miscommunication and lack of communication**: the development team interprets project requirements differently from what the client had in their mind
  - **Customer-related issues**: customers lack understanding of technical processes, leading to unrealistic expectations and tight deadlines that developers struggle to meet

---

## Agile principles in software development

> _"able to move quickly and easily."_ ⎯ Dictionary definition for the word _"agile"_

- The word _"agile"_ is often used in many industries to describe the way of working in organizations
- The word is commonly used in a positive manner, for example, _"we are an agile organization"_, or _"we work in an agile manner"_
...
- The Manifesto for Agile Software Development describes the following values:
  - **Individuals and interactions over processes and tools**: people should communicate directly and work together effectively instead of relying too much on rigid processes or tools
  - **Working software over comprehensive documentation**: the main focus should be on delivering functioning software, while keeping documentation useful but not excessive.
  - **Customer collaboration over contract negotiation**: the team should work closely with the customer throughout the project instead of only following an initial agreement
  - **Responding to change over following a plan**: plans are important, but the team should be ready to adjust them when requirements or circumstances change
...
- One of the key values is the attitude towards **change**
- For example, there is often a need to change the software's requirements during the development process
...
- The Manifesto for Agile Software Development doesn't go into detail on how to actually implement these values in practice
...
- In the **requirements phase**, the development team collects requirements from several stakeholders such as customers and end users
- Requirements describe the features and behaviors of a system from the user's perspective, focusing on **how users interact with it and the outcomes they want to achieve**
- For example, _"As a blog reader I want to browse list of blog posts of a blog so that I can find interesting posts to read"_ could be a requirement for a blog application
- These requirements are commonly documented and managed in so-called _"backlogs"_ which act as a prioritized list of work for the development team
...
- During the design phase different kinds of documentation, such as architecture diagrams, are produced to support the **implementation phase**
...
- The organization of the collaboration during the implementation phase requires the development team to carefully follow mutually agreed **process**
- The development team needs to use different kinds of tools to ease the collaboration, such as **version control tools**, which we will cover later
...
- This means that software developers usually implement a small coding task, write automated test cases for the task and move on to the next task
- This practice is even taken so far that the tests are written **before** the implementation which is referred to as test-driven development (TDD)
...
- In the **maintenance phase**, among other tasks, the development team fixes bugs, resolves user issues, and manages software changes

---
layout: image-right
image: /intro/agile-lifecycle.png
backgroundSize: 23em
class: image-right-sm
---
...
- **Scrum** is a widely adopted iterative software development process framework that defines practical ways to carry out agile software development principles
- Based on the State of Agile report of the year 2022, 87% of respondents used Scrum at the team level
- In the Scrum process, the **Scrum Team** develops software in fixed-length iterations called **Sprints**
- Sprints should be kept short, preferably at most four weeks long
- In each Sprint, there are fixed **events**, which help the Scrum Team organize their work and keep track of the progress of the Sprint
...
- **Scrum Master** is responsible for ensuring that the software development process follows the Scrum practices
...
- Four _events_ take place during each Sprint: **Sprint planning**, **Daily Scrum**, **Sprint Review** and **Retrospective**
- At the beginning of the Sprint, there's a **Sprint planning** event during which the Scrum Team decides which set of requirements are implemented during the upcoming Sprint
- During the Sprint, the Scrum Team organizes **Daily Scrum** meetings to discuss the progress of the Sprint
- At the end of the Sprint, there's a **Sprint Review** event during which the Scrum Team goes through the outcome of the Sprint
- Before starting the next Sprint, the Scrum Team discusses the problems with the process and figures out ways to improve it during the **Retrospective** event
...
- Software’s requirements are commonly categorized as **functional** and **non-functional requirements**
...
- User stories are sort of to-do items, which help the Scrum Team understand and remember what kind of features need to be implemented for the software
- **Use cases** are another, less Agile-friendly, way of defining requirements. They focus more on **how the system will work**, not **what the user needs**
...
- For example, two separate user stories for a blog application could be the following:
  - _"As a content **creator**, I want to **create a new blog** so that **I can start writing blog posts**"_
  - _"As a blog **reader**, I want to **browse list of blog posts of a blog** so that **I can find interesting posts to read**"_
...
- Use the _"As [a user persona], I want [to perform this action] so that [I can accomplish this goal]"_ format
- Try to come up with different user personas for the user stories
- Share your user stories with others and let's discuss about them
...
- The **INVEST criteria** is one popular guideline for a good user story:
...
- This allows faster delivery and feedback and lower risks of requirement misunderstandings and technical issues
- If the description of the feature contains words like _"and"_ or _"or"_, it could be that the user story can be split into smaller user stories
