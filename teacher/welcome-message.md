Software Development Project 1 course starts on Wednesday 26.3.

Hi all!

I would like to welcome you all to the Programming 2 course starting on Wednesday 26.3. Our first session is at 11:00 - 13:45 in class room 4013.

Before the session, read the course's pre-requisites, which you can find here: https://opinto-opas.haaga-helia.fi/course_unit/SOF005AS3AE. If you haven't completed the required courses (or you aren't currently completing them along with the course or you don't already have similar knowledge and skills) it will be impossible to complete the course. Let me know if you have any questions.
